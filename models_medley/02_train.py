...
def train(fold,
    ...
    idx_train = pd.read_json(os.path.join(OUTPUT_PATH, 'index_train{:02d}.json'.format(fold)))
    idx_val = pd.read_json(os.path.join(OUTPUT_PATH, 'index_validate{:02d}.json'.format(fold)))
